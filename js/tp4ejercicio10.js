...
class Avion extends Aeropuerto {
    ...
    #destino;
    listaPasajeros=[];
    constructor(nombreP,capacidadP,destinoP){
        super(nombreAeropuertoP)
        this.#nombre = nombreP;
...
class Aeropuerto {
    #nombreAeropuerto;
    listaDeAviones=[];
    constructor(nombreAeropuertoP) {
        this.#nombreAeropuerto = nombreAeropuertoP;
    }
    ...
    agregarAvion(){
        this.listaDeAviones.push(new Avion())
    }
